...
const championsLeagueMatches = [
  {
    team1: 'CHELSEA',
    team1Logo: '/images/barca.webp',
    team2: 'LIVERPOOL',
    team2Logo: '/images/barca.webp',
    time: '08:00PM'
  },
  {
    team1: 'CHELSEA',
    ...
    content = (
      <>
        ...
        <section style={{ 
          ...
          <div style={{ width: '100%', maxWidth: '1400px', margin: '0 auto', padding: '0 32px' }}>
            <MatchesContainer matches={championsLeagueMatches} />
          </div>
        </section>
