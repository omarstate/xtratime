  ...
  <div className="landing-page" style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', padding: '16px 0' }}>
    ...
    <div className="glass-card" style={{ 
      ...
      <div className="signin-image-panel" style={{ 
        ...
        <img src="/images/salah-faceoff.jpg" alt="Salah" style={{ 
          width: '100%', 
          height: '100%', 
          objectFit: 'cover'
        }} />
      ...
      <div className="signin-form-panel" style={{ 
        ...
        <div style={{ color: '#999', fontSize: '1.1rem', marginBottom: 14, wordBreak: 'break-word' }}>Create your account</div>
        ...
        <form style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 10 }}>
          <div style={{ position: 'relative' }}>
            <span style={{ position: 'absolute', left: 12, top: 10, color: '#666', fontSize: 16 }}>
              <svg width="18" height="18" fill="none" viewBox="0 0 24 24"><path fill="#666" d="M12 12a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm0 2c-2.67 0-8 1.34-8 4v2a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1v-2c0-2.66-5.33-4-8-4Z"/></svg>
            </span>
          ...
          <div style={{ marginTop: 12, textAlign: 'center', fontSize: '1rem', color: '#999', fontWeight: 500 }}>
            ...
            <span style={{ color: '#fff', fontWeight: 700, cursor: 'pointer' }} onClick={onSignIn}>Sign in</span>
          </div>
        </form>
      </div>
    </div>
